...
# Elearning System RESTful API in Lumen
> **Note:** This repository contains the core code of an Elearning System in a RESTful way.
...
## About The Project
RESTful API with Lumen will make the client to server communication easier with HTTP requests. In this project, I have practiced how to develop a real-world, RESTful API with Lumen for a simple Elearning System.
...
* Elearning System in a RESTful way.
...
1. Clone the repo
```sh
git clone https://github.com/Masud99Rana/Elearning-System-API-in-Lumen.git
```
